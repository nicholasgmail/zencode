        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="overflow-hidden shadow-xl sm:rounded-lg">
                <div class="bg-brown text-white px-4 py-4">
                    <div
                        class="w-full bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700 p-3">
                        <div class="flex flex-row items-center justify-between">
                            <div class="flex flex-row items-center">
                                <img class="w-14 h-14 rounded-full shadow-lg p-1"
                                     src="https://flowbite.com/docs/images/people/profile-picture-3.jpg"
                                     alt="Bonnie image">
                                <h5 class="mb-1 text-xl font-medium text-gray-900 dark:text-white ml-1">Bonnie
                                    Green</h5>
                                <span class="text-sm text-gray-500 dark:text-gray-400 ml-1">22.05.22 в 22:30</span>
                            </div>
